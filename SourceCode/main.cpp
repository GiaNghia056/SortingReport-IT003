...
int main()
{
	srand(time(NULL));
	int T = 10, start = 1;
	string inp = "TestCase", out = "Result";
	ofstream fo((out + ".txt").c_str());
	for (int i = 0; i < T; i++)
	{
		string num = str(i + start);
		fo << fixed << setprecision(9);
		fo << "Thoi gian chay " << inp + " " + num << " cua CppLibSort la: " << solveCppLibSort(inp + num, out + num) << "\n";
		fo << "Thoi gian chay " << inp + " " + num << " cua QuickSort la: " << solveQuickSort(inp + num, out + num) << "\n";
		fo << "Thoi gian chay " << inp + " " + num << " cua HeapSort la: " << solveHeapSort(inp + num, out + num) << "\n";
		fo << "Thoi gian chay " << inp + " " + num << " cua MergeSort la: " << solveMergeSort(inp + num, out + num) << "\n";
